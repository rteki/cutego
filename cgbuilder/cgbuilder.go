...
type globalsT struct {
	...
	//path to directory for qt autogenerated files
	EmbedResources bool `json:"embedResources"`
}
...
func generateConfig() {
	...
	config += "  \"buildDest\": \"\"," + EOL + EOL
	config += "  \"//embedResources\": \"If true embeds resources to CuteGo dynamic library\"," + EOL
	config += "  \"embedResources\": false" + EOL
	config += "}" + EOL
